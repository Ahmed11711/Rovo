                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="flex-shrink-0">
                                        <div id="filePreview{{ $name }}"
                                            ...
                                            style="background-image: url('{{ ${$name} ? ${$name}->temporaryUrl() : asset('user-uploads/favicons/restaurant/' . restaurant()->$name) }}'); background-size: contain; background-repeat: no-repeat;">
                                        </div>
                                    </div>
    ...
    <div class="flex items-center space-x-4">
        ...
        <div class="flex-grow space-y-2">
            <input type="file" id="webmanifest" class="hidden"
                ...
                wire:model="webmanifest" x-ref="webmanifest"
                x-on:change="
                const reader = new FileReader();
                reader.onload = (e) => {
